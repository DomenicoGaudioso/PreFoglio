...
def Run_Export1Out_SuperFoglio(pathInput, pathOut):
    ...
    writeOut_xlsx(NewDict, os.path.join(pathOut, "Output_varieCoseNTC_2023.xlsx")) 

    return 

def Run_Export2Out_SuperFoglio(pathInput, pathOut):
    #path: della cartella che contiene i file excel
    ...
    writeOut_xlsx(NewDict, os.path.join(pathOut, "Output_varieCoseFatica_2023.xlsx")) 
